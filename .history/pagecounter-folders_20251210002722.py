...
def acquire_lock():
    ...
    try:
        ...
        if os.name == 'nt':  # Windows
            # On Windows, we use a simple file existence check
        ...
        # Lock already exists or couldn't acquire
        if os.path.exists(lock_path):
            try:
                ...
                print("⚠️ Script already running. Skipping execution.")
        return None
...
def should_send_message(message, min_cooldown_seconds=60):
    """
